...
export interface MeetingDetail { course: LearningCourse; session: Meeting; counts: AttendanceCounts; qrBreakdown: QrBreakdown; roster: Page<AttendanceRow>; checkin: CheckinState }
