...
import { createCurriculumHandler } from "./core/curriculum-http";
import { createLinksHandler } from "./core/links-http";
...
const server = Bun.serve({
  ...
  routes: { ...brandRoutes, "/": index, "/login": index, "/dashboard": index, "/calendar": index, "/notifications": index, "/account": index,"/admin/users": index, "/admin/import": index, "/admin/transfers": index, "/admin/academic": index, "/admin/audit": index, "/learning": index, "/curriculum": index, "/links": index, "/learning/courses/:id": index, "/learning/courses/:id/attempts/:attemptId": index, "/projects": index, "/projects/:id": index, "/gamification": index, "/club": index, "/reports": index, "/attendance": index, "/attendance/courses/:id": index, "/attendance/courses/:id/sessions/:sessionId": index },
