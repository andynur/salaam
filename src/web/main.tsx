...
function App() {
  ...
  const loadSession = useCallback(async () => {
    ...
    try { setSession(await api<Session>("/api/auth/me")); if (!location.pathname.startsWith("/admin/") && !location.pathname.startsWith("/learning") && !location.pathname.startsWith("/projects") && !location.pathname.startsWith("/gamification")) history.replaceState(null, "", "/dashboard"); }
    catch (cause) {
