...
async function main() {
  ...
  await db.begin(async tx => {
    ...
    const academicCalendarEvents: [string, string, string, string, string, string | null][] = [
      ...
      ["Serah Terima Santri", "Orientasi dan serah terima santri baru.", "2026-07-12", "2026-07-12", "student", null],
      ["MPLS", "Masa pengenalan lingkungan sekolah.", "2026-07-13", "2026-07-19", "student", null],
      ...
      ["Prakiraan Libur I'tikaf Ramadhan 1448 H", "Tanggal dapat berubah mengikuti keputusan resmi.", "2027-02-28", "2027-02-28", "holiday", null],
      ["Libur I'tikaf", "Libur dan persiapan I'tikaf.", "2027-03-01", "2027-03-08", "holiday", null],
      ["Perkiraan Iedul Fitri", "Tanggal dapat berubah mengikuti keputusan resmi.", "2027-03-09", "2027-03-09", "holiday", null],
      ["Libur Iedul Fitri", "Libur Iedul Fitri.", "2027-03-10", "2027-03-19", "holiday", null],
      ["Kedatangan Santri", "Kedatangan santri setelah libur Iedul Fitri.", "2027-03-20", "2027-03-20", "student", null],
      ...
      ["Iedul Adha", "Libur Iedul Adha.", "2027-05-16", "2027-05-16", "holiday", null],
      ["Libur Iedul adha", "Libur Iedul Adha.", "2027-05-17", "2027-05-18", "holiday", null],
      ...
      ["Portofolio", "Pengumpulan dan presentasi portofolio semester genap.", "2027-06-13", "2027-06-15", "learning", null],
      ["Class Meeting", "Pertemuan kelas dan evaluasi akhir tahun.", "2027-06-16", "2027-06-17", "student", null],
    ];
