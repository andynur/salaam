-- Gives Asisten Mentor the same scoped read workspaces as teachers without learning authoring privileges.
INSERT INTO role_permissions (role_id, permission_id)
SELECT r.id, p.id FROM roles r CROSS JOIN permissions p
WHERE r.key = 'asmen' AND p.key IN ('dashboard:view', 'reports.view', 'club.view', 'links.view');
